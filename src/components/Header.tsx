...
export const Header = () => {
  ...
  const cartCount = 5; // This will come from context later
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link to="/" className="text-2xl font-playfair font-bold bg-gradient-primary bg-clip-text text-transparent">
              LuxeCart
            </Link>
          </div>
